...
def update_output_container(input_year,selected_statistics):
    if selected_statistics == 'Recession Period Statistics':
        ...
        R_chart3 = dcc.Graph(
            figure=px.pie(exp_rec, values='Advertising_Expenditure', names='Vehicle_Type',
                          title='Pie Chart of Expenditure by vehicle type during recession')
        )

        # Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        emp_rec = recession_data.groupby(['Vehicle_Type', 'unemployment_rate'])['Automobile_Sales'].mean().reset_index()
        R_chart4 = dcc.Graph(
            figure=px.bar(emp_rec, x='unemployment_rate', y='Automobile_Sales', color='Vehicle_Type',
    ...
    # Yearly Statistic Report Plots
        ...
        Y_chart3 = dcc.Graph(
            figure=px.bar(avr_vdata, x='Vehicle_Type', y='Automobile_Sales', color='Vehicle_Type',
...
if __name__ == '__main__':
    app.run_server(debug=False,port=7077)
